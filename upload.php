...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        <h4>Upload something</h4><hr>
	        <input type="file" required id="image" name="image" style="width:200px; height:30px; " /><br />
	        <input type="submit" value="Submit" style="width:100px" class="info settings_submit"/><br/>
	    </form><br />
