	...
	public function getNotifications($data,$limit){
		...
		while($row=mysqli_fetch_array($query)) {
			...
			$return_string.="<a href='".$row['link']."'>
				...
				<div class='notificationProilePic'>
		...
		if($count>$limit)
			...
			$return_string.="<input type='hidden' class='noMoreDropdownData' value='true'><p style='text-align:center;margin-top:15px;'>No more notifications to load</p>";
