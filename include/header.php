...
<body>
	...
	<div class="top_bar">
		...
		<nav>
			...
			<a href="index.php">
				<i class="fa fa-home fa-lg" style="font-size: 20px"></i>
			</a>
			<a href="javascript:void(0);" onclick="getDropdownData('<?php echo $userLoggedIn; ?>','message')">
				<i class="fa fa-envelope fa-lg" style="font-size: 20px"></i>
			...
			<a href="javascript:void(0);" onclick="getDropdownData('<?php echo $userLoggedIn; ?>','notification')">
				...
				<i class="fa fa-bell-o fa-lg" style="font-size: 20px"></i>
			...
			<a href="requests.php">
				...
				<i class="fa fa-users fa-lg" style="font-size: 20px"></i>
				<?php
				if($num_request>0)
			...
			<a href="settings.php"><i class="fa fa-cog fa-lg" style="font-size: 20px"></i></a>

			<a href="include/handlers/logout.php"><i class="fa fa-sign-out fa-lg" style="font-size: 20px"></i></a>
		</nav>
